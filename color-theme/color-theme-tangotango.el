...
(defun color-theme-tangotango ()
  ...
  (color-theme-install
   '(color-theme-tangotango
     ...
     (mode-line ((t (:foreground "#eeeeee" :background "DarkRed" :box (:line-width 1 :color nil :style released-button)))))
     (mode-line-inactive ((t (:foreground "#cccccc" :background "grey10"))))
     (mode-line-buffer-id ((t (:bold t :foreground "white" :background nil))))
     ...
     (font-lock-function-name-face ((t (:foreground "YellowGreen" :bold t))))
     (comint-highlight-input ((t (:italic t :bold t))))
     (comint-highlight-prompt ((t (:foreground "#8ae234"))))
     (isearch ((t (:background "#f57900" :foreground "#2e3436"))))
     (isearch-lazy-highlight-face ((t (:foreground "#2e3436" :background "#e9b96e"))))
     (show-paren-match-face ((t (:foreground "SlateBlue" :background "Aquamarine"))))
     (show-paren-mismatch-face ((t (:background "turquoise" :foreground "White"))))
